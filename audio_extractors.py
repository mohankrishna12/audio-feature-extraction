...
def getFeatures(audiofile):
	allFeatures = pd.concat((extract_features(audiofile), get_filtered(audiofile)), axis=1)

	#print(allFeatures.shape)
	return allFeatures


#print(getFeatures(audiofile))

'''
def extract_dir_overall_features(
	file
    mono_parse = False, # mono-tize files
    filter_band = False, 
    filter_directory = '', 
    filter_lowcut = 20.0, 
    filter_highcut = 250.0): 
